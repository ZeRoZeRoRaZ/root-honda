...
adb/adb shell "su -c 'chmod 666 /data/data/whitelist-1.0.xml'"
adb/adb shell "cp /data/data/whitelist-1.0.xml /data/local/tmp/"
adb/adb shell "su -c 'chmod 666 /data/local/tmp/whitelist-1.0.xml'"
adb/adb pull /data/local/tmp/whitelist-1.0.xml whitelist-1.0.xml
...
adb/adb shell "cp /data/data/whitelist-1.0.xml /data/local/tmp/whitelist-1.0-$ts.xml"
echo "Making an extra backup of whitelist on your PC..."
adb/adb pull /data/local/tmp/whitelist-1.0-$ts.xml .

echo "Uploading whitelist to tmp..."
adb/adb push whitelist-1.0-new.xml /data/local/tmp/whitelist-1.0-new.xml

adb/adb shell "su -c 'cp /data/local/tmp/whitelist-1.0-new.xml /data/data/whitelist-1.0.xml'"
adb/adb shell "su -c 'chown system:system /data/data/whitelist-1.0.xml'"
adb/adb install -r -d $1
